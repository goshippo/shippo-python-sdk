...
from ...models.components import invoicelistwrapper as components_invoicelistwrapper
...
class ListInvoicesResponse:
    ...
    invoice_list_wrapper: Optional[components_invoicelistwrapper.InvoiceListWrapper] = dataclasses.field(default=None)
