...
class ListUserParcelTemplatesGlobalsTypedDict(TypedDict):
...
class ListUserParcelTemplatesGlobals(BaseModel):
...
class ListUserParcelTemplatesRequestTypedDict(TypedDict):
    pass


class ListUserParcelTemplatesRequest(BaseModel):
    pass
