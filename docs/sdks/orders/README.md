...
<!-- UsageSnippet language="python" operationID="ListOrders" method="get" path="/orders" -->
```python
...
<!-- UsageSnippet language="python" operationID="GetOrder" method="get" path="/orders/{OrderId}" -->
```python
from shippo import Shippo
