...
from .servicegroupaccountandservicelevel import ServiceGroupAccountAndServiceLevel, ServiceGroupAccountAndServiceLevelTypedDict
...
class ServiceGroupUpdateRequestTypedDict(TypedDict):
    description: str
...
class ServiceGroupUpdateRequest(BaseModel):
    description: str
    r"""Description for the service group"""
    name: str
    r"""Name for the service group that will be shown to customers in the response"""
