...
class CustomsDeclarationCreateRequestAddressTypedDict(TypedDict):
...
class CustomsDeclarationCreateRequestAddress(BaseModel):
...
class CustomsDeclarationCreateRequestDutiesPayorTypedDict(TypedDict):
    ...
    type: NotRequired[CustomsDeclarationCreateRequestType]
    r"""Party to be billed for duties."""
    address: NotRequired[CustomsDeclarationCreateRequestAddressTypedDict]


class CustomsDeclarationCreateRequestDutiesPayor(BaseModel):
    r"""Specifies who will pay the duties for the shipment. Only accepted for FedEx shipments."""

    account: Optional[str] = None
    r"""Account number to be billed for duties."""

    type: Optional[CustomsDeclarationCreateRequestType] = None
    r"""Party to be billed for duties."""
