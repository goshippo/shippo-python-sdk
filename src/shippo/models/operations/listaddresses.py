...
class ListAddressesGlobalsTypedDict(TypedDict):
    shippo_api_version: NotRequired[str]
    r"""String used to pick a non-default API version to use"""
    

class ListAddressesGlobals(BaseModel):
...
class ListAddressesRequestTypedDict(TypedDict):
...
class ListAddressesRequest(BaseModel):
