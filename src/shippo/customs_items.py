...
class CustomsItems:
    ...
    def create(self, request: components.CustomsItemBase) -> components.CustomsItem:
        ...
        headers = { **utils.get_headers(request, _globals), **headers }
        req_content_type, data, form = utils.serialize_request_body(request, components.CustomsItemBase, "request", False, False, 'json')
