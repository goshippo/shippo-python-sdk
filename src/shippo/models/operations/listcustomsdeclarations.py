...
import dataclasses
from ...models.components import customsdeclarationlistwrapper as components_customsdeclarationlistwrapper
...
class ListCustomsDeclarationsResponse:
    ...
    customs_declaration_list_wrapper: Optional[components_customsdeclarationlistwrapper.CustomsDeclarationListWrapper] = dataclasses.field(default=None)
