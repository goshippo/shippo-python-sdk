...
class ListShippoAccountsGlobalsTypedDict(TypedDict):
...
class ListShippoAccountsGlobals(BaseModel):
...
class ListShippoAccountsRequestTypedDict(TypedDict):
...
class ListShippoAccountsRequest(BaseModel):
    page: Annotated[
        Optional[int],
