...
class WebhookPayloadWebhookPayloadTransaction:
    ...
    data: Optional[Transaction] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class WebhookPayloadWebhookPayloadBatch:
    r"""Content of the webhook posted to the external URL"""
    event: Optional[WebhookEventTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('event'), 'exclude': lambda f: f is None }})
    r"""Type of event that triggered the webhook."""
    test: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('test'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class WebhookPayloadWebhookPayloadTrack:
    r"""Content of the webhook posted to the external URL"""
    event: Optional[WebhookEventTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('event'), 'exclude': lambda f: f is None }})
    r"""Type of event that triggered the webhook."""
    test: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('test'), 'exclude': lambda f: f is None }})
...
WebhookPayload = Union[WebhookPayloadWebhookPayloadTrack, WebhookPayloadWebhookPayloadBatch, WebhookPayloadWebhookPayloadTransaction]
