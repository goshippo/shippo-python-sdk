...
class AddressTypedDict(TypedDict):
    ...
    **Carrier-Specific Constraints:**
    ...
    r"""Complete addresses contain all required values.

    Incomplete addresses have failed one or multiple validations. Incomplete Addresses are eligible for requesting rates but lack at least one required value for purchasing labels.
    """
