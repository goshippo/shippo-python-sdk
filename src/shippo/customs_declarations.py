...
class CustomsDeclarations(BaseSDK):
    ...
    def create(
        self, *,
        request: Union[components.CustomsDeclarationCreateRequest, components.CustomsDeclarationCreateRequestTypedDict],
        server_url: Optional[str] = None,
        ...
        request = components.CustomsDeclarationCreateRequest(
            request=utils.unmarshal(request, components.CustomsDeclarationCreateRequest) if not isinstance(request, BaseModel) else request,
        )
        ...
        req = self.build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request, False, False, "json", components.CustomsDeclarationCreateRequest),
        )
