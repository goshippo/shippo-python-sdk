...
class DeleteDefaultParcelTemplateGlobalsTypedDict(TypedDict):
...
class DeleteDefaultParcelTemplateGlobals(BaseModel):
...
class DeleteDefaultParcelTemplateRequestTypedDict(TypedDict):
    pass


class DeleteDefaultParcelTemplateRequest(BaseModel):
    pass
