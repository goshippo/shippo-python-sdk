...
class GetDefaultParcelTemplateGlobalsTypedDict(TypedDict):
...
class GetDefaultParcelTemplateGlobals(BaseModel):
...
class GetDefaultParcelTemplateRequestTypedDict(TypedDict):
    pass


class GetDefaultParcelTemplateRequest(BaseModel):
    pass
